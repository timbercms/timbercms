        ...
        <div class="component-item">
            ...
            <div class="component-controllers">
                ...
                <div class="component-controller">
                    ...
                    <a href="index.php?component=menu&controller=menuitem<?php echo (strlen($_GET["id"]) > 0 ? "&overwrite=1&id=". $_GET["id"] : ""); ?>&menu_id=<?php echo $_GET["menu_id"]; ?>&comp=system&cont=external" class="button">Select</a>
                </div>
                <div class="component-controller">
                    <p><strong>Alias</strong></p>
                    <p>Use a link generated by another menu item.</p>
                    <a href="index.php?component=menu&controller=menuitem<?php echo (strlen($_GET["id"]) > 0 ? "&overwrite=1&id=". $_GET["id"] : ""); ?>&menu_id=<?php echo $_GET["menu_id"]; ?>&comp=system&cont=alias" class="button">Select</a>
                </div>
            </div>
        </div>
