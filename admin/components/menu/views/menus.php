        ...
        <table>
            ...
            <?php foreach ($this->model->menus as $menu) { ?>
                <tr>
                    ...
                    <td class="frame-2"><a href="index.php?component=menu&controller=menuitems&id=<?php echo $menu->id; ?>" class="button"><i class="fa fa-pencil"></i> Menu Items (<?php echo count($menu->items); ?>)</a></td>
                </tr>
            <?php } ?>
        </table>
    </form>
