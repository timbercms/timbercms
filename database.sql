...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2017 at 12:20 AM
...
INSERT INTO `bgdy_components` (`id`, `title`, `description`, `internal_name`, `is_frontend`, `is_backend`) VALUES
(3, 'Content', NULL, 'content', 1, 0);
...
(5, 'Smith0r', 'Chris Smith', 'smith0r54@gmail.com', 3, NULL, 1, 0, NULL, 1487513679, NULL, NULL);
