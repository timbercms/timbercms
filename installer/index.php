...
RedirectMatch 404 ^404.php';
            ...
            <?php } else if ($_GET["stage"] == 3) { ?>
                <?php
                    ...
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Content", "Article category and detail view. Includes comments via third-party Disqus.", "content", "1", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", 'a:1:{s:15:"enable_comments";s:1:"0";}', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("User", "Provides functions for account management, and profile views.", "user", "1", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Settings", "Provides sitewide, and component specific settings.", "settings", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", 'a:2:{s:10:"site_title";s:13:"Bulletin. CMS";s:16:"default_template";s:7:"default";}', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Extensions", "Provides management of extensions.", "extensions", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Menu Manager", "Basic Menu Management.", "menu", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Module Manager", "Basic Module Management.", "modules", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Update Manager", "Allow updating of the base CMS.", "update", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Contact", "Contact Form display. Sends email to configured address.", "contact", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0", 'a:3:{s:11:"admin_email";s:'. strlen($_POST["email"]) .':"'. $_POST["email"] .'";s:14:"complete_title";s:23:"Thanks for your message";s:16:"complete_message";s:81:"<p>Thank you for getting in touch. We\'ll get back to you as soon as possible.</p>";}', "1"));
                    $db->query("INSERT INTO #__components_modules (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Latest News", "Show the latest news in a list", "latestnews", "1", "0", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0"));
                    $db->query("INSERT INTO #__components_modules (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Main Menu", "Show the main menu.", "mainmenu", "1", "0", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0"));
                    $db->query("INSERT INTO #__components_modules (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Login", "Show login form.", "login", "1", "0", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0"));
                    $db->query("INSERT INTO #__components_modules (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", array("HTML", "Custom HTML Module.", "html", "1", "0", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0"));
                    $db->query("INSERT INTO #__components_modules (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Menu", "Show menu items in a menu format.", "menu", "1", "0", "1", "Chris Smith", "https://github.com/Smith0r", "1.0.0"));
