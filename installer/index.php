...
RedirectMatch 404 ^404.php';
            ...
            <?php } else if ($_GET["stage"] == 3) { ?>
                <?php
                    ...
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, is_core, author_name, author_url, version, params, enabled, ordering) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Update Manager", "Allow updating of the base CMS.", "update", "0", "1", "1", "1", "Chris Smith", "https://github.com/Smith0r", $version->numerical, '', "1", "7"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, is_core, author_name, author_url, version, params, enabled, ordering) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("About", "Provides information about packages and installed CMS.", "about", "0", "1", "1", "0", "Chris Smith", "https://github.com/Smith0r", $version->numerical, '', "1", "0"));
                    ...
                    $db->query("INSERT INTO #__articles_categories (title, alias, description, published, ordering, params, parent_id) VALUES (?, ?, ?, ?, ?, ?, ?)", array("Site Pages", "site-pages", "", "1", "publish_time DESC", 'a:1:{s:10:"show_title";s:1:"1";}', "0"));
