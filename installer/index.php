...
RedirectMatch 404 ^404.php';
            ...
            <?php } else if ($_GET["stage"] == 3) { ?>
                <?php
                    ...
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Update Manager", "Allow updating of the base CMS.", "update", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.1.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("About", "Provides information about packages and installed CMS.", "about", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.1.0", '', "1"));
                    $db->query("INSERT INTO #__components (title, description, internal_name, is_frontend, is_backend, is_locked, author_name, author_url, version, params, enabled) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", array("Contact", "Contact Form display. Sends email to configured address.", "contact", "0", "1", "1", "Chris Smith", "https://github.com/Smith0r", "1.1.0", 'a:3:{s:11:"admin_email";s:'. strlen($_POST["email"]) .':"'. $_POST["email"] .'";s:14:"complete_title";s:23:"Thanks for your message";s:16:"complete_message";s:81:"<p>Thank you for getting in touch. We\'ll get back to you as soon as possible.</p>";}', "1"));
